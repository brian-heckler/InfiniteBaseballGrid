...
class DataAnalysis:
    def __init__(self):
        ...
        self.db: Database = Database(MongoClient("mongodb+srv://bheckler24:dyEtBbNrv1YFmoqk@magic-doku.gzi2n0j.mongodb.net/?retryWrites=true&w=majority&appName=magic-doku"), False)
    @staticmethod
